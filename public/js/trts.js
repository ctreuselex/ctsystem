...
var charTraits = [
	...
	{ 	id: 'half-soaked', name: 'Half Soaked',
		...
		stats: [
			{ value: 2, stat: 'affinity', con: 'drenched', contype: 'status', target: 'self', },
			{ value: -2, stat: 'energycost', con: 'drenched', contype: 'status', target: 'self', },
	...
	{ 	id: 'aquatic',  name: 'Aquatic',
		...
		stats: [
			...
			{ value: -3, stat: 'energycost', con: 'drenched', contype: 'status', target: 'self', }, 
    ...
    {   id: 'the-beautiful-elite', name: 'The Beautiful Elite',
        ...
        stats: [
            { value: 8, stat: 'spirit', con: '', contype: '', target: 'self', },
            { value: 5, stat: 'persuasion', con: '', contype: '', target: 'self', },
            { value: -3, stat: 'spirit', con: '', contype: '', target: 'party', },
        ]},
    ...
    {   id: 'mighty-glacier', name: 'Mighty Glacier',
        ...
        stats: [
            { value: 8, stat: 'affinity', con: '', contype: '', target: 'self', },
            { value: -8, stat: 'myst', con: '', contype: '', target: 'self', },
        ]},

    {   id: 'fireman', name: 'Fireman',
        icon: 'ra ra-candle-fire', special: '',
        des: 'For some reaon, they are do not have the liking of fire for someone with "fire" on their title. It\'s just weird and a bit disorienting. Even more if one realized that they like water the best.',
        stats: [
    ...
    {   id: 'finger-gunner', name: 'Finger Gunner',
        ...
        stats: [
            { value: 5, stat: 'myst', con: 'myst-amplified', contype: 'status', target: 'self', },
            { value: 1, stat: 'weapon', con: 'gun', contype: 'equip', target: 'self', },
        ]},
    ...
    {   id: 'extremely-omnisexual', name: 'Extremely Omnisexual',
        ...
        des: 'Everbody knows that there is nothing that can stop them from "doing their thing" and with such knowledge came the fact that a little glare of disgust is deserved.',
        stats: [
	...
	{	id: 'hydrophobe', name: 'Hydrophobe',
		...
		stats: [
			...
			{ value: -5, stat: 'affinity', con: 'drenched', contype: 'status', target: 'self', },
		]},
	...
	{ 	id: 'thunderstruck', name: 'Thunderstruck',
		...
		stats: [
			...
			{ value: 1, stat: 'energy', con: '', contype: '', target: 'self', },
			{ value: 1, stat: 'sparkresist', con: '', contype: '', target: 'self', },
		]},
    ...
    {   id: 'not-quite-dead', name: 'Not Quite Dead',
        ...
        stats: [
            { value: 'Returns Health to 1 after being hit by a killing blow once per scenario', stat: 'special', con: '', contype: '', target: 'self', },
        ]},
	...
	{	id: 'bodybuilder', name: 'Bodybuilder',
		...
		stats: [
			...
			{ value: '+50% more Health from Body', stat: 'special', con: 'athletic', contype: 'trait', target: 'self', },
		]},

    {   id: 'art-attacker', name: 'Art Attacker',
        icon: 'ra ra-diamond', special: '',
	...
	{ 	id: 'intimidating', name: 'Intimidating',
		...
		stats: [
            { value: 'Never fail persuading people with your intimidating upside-down frown', stat: 'special', con: 'perpetual-frowner', contype: 'trait', target: 'self', },
			{ value: 1, stat: 'body', con: '', contype: '', target: 'self', },
			{ value: 1, stat: 'persuasion', con: '', contype: '', target: 'self', },
		]},
];
...
function checkSpecialTraits(char, traits, traitfin, traitups, partytraitups, affinity) {
	if (checkCharTraits('bodybuilder', traits)) { // +50% health from body (bodybuilder + athletic)
		if (checkCharTraits('athletic', traits)) { 
			traitfin['health'] = char['mhealth'] + (traitfin['body'] * 3) + traitups['health'] + partytraitups['health'];
		}
	}
